...
export type AddTaskReqBody = {
    /**
     * A URL to the JSON Schema for this object.
     */
    readonly $schema?: string;
    /**
     * ID of board task will be added to
     */
    boardId: string;
    /**
     * column the task should belong to
     */
    columnId: string;
    /**
     * Task to be added
...
export type SubtaskInput = {
    /**
     * ID of subtask (empty for new subtasks)
     */
    id?: string;
    /**
     * name of subtask
